  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Tooltip(
            message: S.current.Desasignar_actividad,
            waitDuration: const Duration(milliseconds: 100),
            showDuration: const Duration(seconds: 2), // Tiempo visible
            child: Text(S.current.Desasignar_actividad),
          ),
          actions: [
            Container(
                            ...
                            ? ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ListTileCustom(
                                    title:
                                        stateChildren.children[index].fullName,
                                    colorTitle: true,
                                    ...
                                    image:
                                        stateChildren.children[index].imageUrl,
                                            ...
                                            question: RichText(
                                              text: TextSpan(
                                                children: [
                                                  TextSpan(
                                                    text:
                                                        '${S.current.Esta_seguro_de_desasignar_la_actividad(widget.nameActivity!['nameActivity'])}\n\n',
                                                    style: const TextStyle(
                                                      color: $colorTextBlack,
                                                    ),
                                                  ),
