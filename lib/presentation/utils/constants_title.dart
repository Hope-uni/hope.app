const String $titleAppMain = 'Hope App';
const String $titleNombreApp = 'hope';
const String $titleLogin = 'Iniciar sesión';
const String $titleRightsReserved = '© 2023 Hope. All rights reserved';
const String $titlePlaceholderUser = 'Usuario';
...
const String $titleMenuSettings = 'Configuración';
const String $titleMenuLogout = 'Cerrar sesión ';
